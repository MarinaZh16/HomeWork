...
--
-- Name: ganre; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ganre (
    ganre_id integer NOT NULL,
    ganres text NOT NULL
);


ALTER TABLE public.ganre OWNER TO postgres;

--
-- Name: ganre_film; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ganre_film (
    ganre_id integer NOT NULL,
    film_id integer NOT NULL
);


ALTER TABLE public.ganre_film OWNER TO postgres;

--
-- Name: ganre_ganre_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.ganre_ganre_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.ganre_ganre_id_seq OWNER TO postgres;

--
-- Name: ganre_ganre_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.ganre_ganre_id_seq OWNED BY public.ganre.ganre_id;
...
--
-- Name: ganre ganre_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ganre ALTER COLUMN ganre_id SET DEFAULT nextval('public.ganre_ganre_id_seq'::regclass);
...
COPY public.actor (actor_id, surname, name, actor_name) FROM stdin;
1	Харди	Том	Том Харди
2	Дикаприо	Леонардо	Леонардо Дикаприо
3	Котийяр	Марион	Марион Котийяр
4	Ватанабе	Кен	Кен Ватанабе
5	Круз	Том	Том Круз
6	Питт	Брэд	Брэд Питт
7	Деймон	Мэтт	Мэтт Деймон
8	Кавилл	Генри	Генри Кавилл
9	Уиллис	Брюс	Брюс Уиллис
10	Йовович	Милла	Милла Йовович
\.
...
--
-- Data for Name: ganre; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ganre (ganre_id, ganres) FROM stdin;
...
--
-- Data for Name: ganre_film; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ganre_film (ganre_id, film_id) FROM stdin;
1	1
2	1
3	2
4	2
...
--
-- Name: ganre_ganre_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.ganre_ganre_id_seq', 11, true);
